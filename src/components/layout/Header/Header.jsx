...
function Header(){
  ...
  return (
    <header
        className="flex flex-col items-center justify-center lg:grid lg:grid-cols-2 lg:justify-items-center lg:content-center gap-12 lg:gap-5 xl:gap-12 px-8 xl:px-0 cursor-default lg:w-[1100px] xl:w-[1400px] transition-all ease-in duration-200">
