...
function Home() {
  ...
  return (
    <section className="page flex flex-col items-center justify-center lg:grid lg:grid-cols-2 lg:justify-items-center lg:content-center gap-5 lg:gap-5 pb-10 px-8 xl:px-0 cursor-default lg:w-[1100px] xl:w-[1200px] 2xl:w-[1300px] transition-all ease-in duration-200">
      <section className="flex flex-col items-start  justify-center gap-8">
        ...
        <div className="flex flex-col gap-5 justify-center items-start  ">
          ...
          <div className="flex flex-col items-start  justify-center gap-8">
            <div className="flex flex-col justify-center items-start gap-5">
              ...
              <p className="text-gray-400 text-md lg:text-xl font-semibold lg:text-left ">
                Passionate about creating beautiful, functional web experiences with modern technologies. I specialize in React, JavaScript, and responsive design, always eager to learn and grow in the ever-evolving world of web development.
              </p>
            </div>
            <div className="flex flex-col md:flex-row gap-4">
              <div className="flex gap-2 items-center">
                <Img style="w-4" src="./img/icons/mail.svg" alt="mail" />
        ...
        <div className="flex items-center justify-center gap-3">
          <Button style="flex gap-3 items-center px-8 py-3 bg-gradient-to-r from-cyan-500 to-teal-400 rounded-xl border border-cyan-500 text-black font-semibold text-sm shadow-2xl shadow-cyan-800/20 brightness-110 hover:transform hover:translate-y-[-2px] transition-all ease-in duration-200 xl:cursor-pointer group/contact ">
            <Img
              style="w-4 transition-all ease-in duration-200 group-hover/contact:scale-110"
              src="./img/icons/mail-black.svg"
              alt="mail"
            />
            Get in touch
          </Button>
          <Button style="flex gap-3 items-center px-8 py-3 bg-gradient-to-r from-black to-gray-900 rounded-xl border border-gray-800 text-white font-semibold text-sm shadow-2xl shadow-cyan-900/20 hover:brightness-150 hover:border-cyan-400 transition-all ease-in duration-200 xl:cursor-pointer group/download">
            <Img
              style="w-4 transition-all ease-in duration-200 group-hover/download:scale-110"
        ...
        <div className="flex gap-4">
          ...
          >
            <img
              className=" w-4  lg:group-hover/github:brightness-0 "
          ...
          >
            <img
              className=" w-4  lg:group-hover/linkedin:brightness-0 "
          ...
          >
            <img
              className=" w-4  lg:group-hover/instagram:brightness-0 "
      ...
      <section className="flex justify-center  items-center lg:w-full relative">
        ...
        <div
          ref={experience}
          className="absolute -bottom-5 lg:bottom-2  -left-5 lg:-left-6 xl:left-10 z-10 text-[12px] font-semibold rounded-xl px-3 py-1 bg-gradient-to-r from-neutral-800/80  to-zinc-900/80  lg:hover:brightness-110   "
        >
          <p> 2+ Years of Experience</p>
        </div>
        <div className="flex items-end justify-center rounded-full overflow-hidden w-98 h-98 lg:w-[400px] lg:h-[400px] backdrop-blur-md bg-neutral-700  border-10 border-neutral-950/80  lg:hover:transform lg:hover:-translate-y-2 lg:hover:shadow-2xl lg:hover:shadow-cyan-500/10 transition-all duration-200 ease-in">
          <img
            className="w-full h-full object-top object-cover"
            src="./img/photos/portfolio.png"
            alt=""
          />
        </div>
      </section>
